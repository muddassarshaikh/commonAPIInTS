...
import fs from 'fs';
import db from '../user/database/mysql/mysql';
// let db;
// if (config.database === 'mysql') {
//   db = '../user/database/mysql/mysql';
// } else {
//   db = '../user/database/mongoDB/mongoDB';
// }
...
class UserService {
  ...
  async registration(info) {
    try {
      ...
      let emailMessage = fs
        .readFileSync('./src/common/emailtemplate/welcome.html', 'utf8')
        .toString();
  ...
  async forgotPassword(info) {
    try {
      ...
      let emailMessage = fs
        .readFileSync('./src/common/emailtemplate/reset.html', 'utf8')
        .toString();
      emailMessage = emailMessage
